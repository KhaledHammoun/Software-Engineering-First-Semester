...
public class MyDate
{
  ...
  private int month;
  private int year;
  static GregorianCalendar todaysDate = new GregorianCalendar();
  ...
  public MyDate()
  {
    this.day = todaysDate.get(GregorianCalendar.DATE);
    this.month = todaysDate.get(GregorianCalendar.MONTH)+1;
    this.year = todaysDate.get(GregorianCalendar.YEAR);
  }
  ...
  {
    int currentDay = todaysDate.get(GregorianCalendar.DATE);
    int currentMonth = todaysDate.get(GregorianCalendar.MONTH)+1;
